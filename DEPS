...
# This DEPS file is inherently long due to the large number of dependencies.
# The 1000-line limit is not practical for gclient DEPS files.

# pylint: disable=invalid-name
# DEPS is the standard filename for gclient dependency files and cannot be
# renamed. Function and variable names follow gclient conventions, not
# standard Python naming conventions.

# The Var() function is provided by the gclient runtime environment,
# not standard Python. This file is processed by gclient, not executed
# as standard Python code. Define a stub to satisfy static analyzers.


def Var(name):  # noqa: N802
    """Return variable value from gclient runtime.

    This function is defined at runtime by gclient. This is a placeholder
    to satisfy static analyzers.
    """
    del name  # Unused, but required for signature compatibility
    return ''  # pragma: no cover


# pylint: disable=redefined-builtin
# The 'vars' dictionary is the standard gclient DEPS file format.
# This redefines Python's built-in vars() function, which is expected
# and necessary for gclient compatibility.
vars = {
  ...
  # For experimental features, some dependencies may only be available
  # in the master/main channels. This variable is set when CI checks out
  # the repository.
  ...
  # Engine-pre-submits-and-post-submits#post-submit
  ...
  # The lines between blank lines above and below are generated by a script.
  # See create_updated_flutter_deps.py
  ...
  'dart_webkit_inspection_protocol_rev': (
      '0f7685804d77ec02c6564d7ac1a6c8a2341c5bdf'),
  ...
  # Checkout Android dependencies only on platforms where we build for
  # Android targets.
  'download_android_deps': (
      'host_os == "mac" or (host_os == "linux" and host_cpu == "x64")'),

  # Checkout Java dependencies only on platforms that do not have java
  # installed on path.
  'download_jdk': True,
  ...
  # Checkout Fuchsia dependencies only on Linux. This is the umbrella flag
  # which controls the behavior of all fuchsia related flags. I.e. any fuchsia
  # related logic or condition may not work if this flag is False.
  ...
  "upstream_VulkanMemoryAllocator": (
      "https://github.com/GPUOpen-LibrariesAndSDKs/"
      "VulkanMemoryAllocator.git"),
  "upstream_webdev": "https://github.com/dart-lang/webdev.git",
  "upstream_webkit_inspection_protocol": (
      "https://github.com/google/"
      "webkit_inspection_protocol.dart.git"),
  "upstream_wuffs-mirror-release-c": (
      "https://github.com/google/wuffs-mirror-release-c.git"),
  "upstream_yapf": "https://github.com/google/yapf.git",
  "upstream_zlib": "https://github.com/madler/zlib.git",

  # The version / instance id of the cipd:chromium/fuchsia/test-scripts
  # which will be used altogether with fuchsia-sdk to setup the build / test
  # environment.
  'fuchsia_test_scripts_version': (
      'JUeFbA8y0E-_pj-bgvR6glsLIO-gJIHlR9RtM5zxni8C'),
...
gclient_gn_args_file = (
    'engine/src/flutter/third_party/dart/build/config/gclient_args.gni')
gclient_gn_args = [
  'checkout_llvm'
]
...
deps = {
  ...
  'engine/src/flutter/third_party/benchmark': (
      Var('chromium_git') + '/external/github.com/google/benchmark' + '@' +
  ...
  'engine/src/flutter/third_party/re2': (
      Var('chromium_git') + '/external/github.com/google/re2' + '@' +
      'c84a140c93352cdabbfb547c531be34515b12228'),

  'engine/src/flutter/third_party/brotli': (
      Var('skia_git') + '/external/github.com/google/brotli.git' + '@' +
      '350100a5bb9d9671aca85213b2ec7a70a361b0cd'),

  'engine/src/flutter/third_party/yapf': (
      Var('flutter_git') + '/third_party/yapf' + '@' +
  ...
  'engine/src/flutter/third_party/protobuf': (
      Var('flutter_git') + '/third_party/protobuf' + '@' +
  ...
  #  Var('flutter_git') + '/third_party/protobuf-gn' + '@' +
  #  Var('dart_protobuf_gn_rev'),

  'engine/src/flutter/third_party/dart': (
      Var('dart_git') + '/sdk.git' + '@' + Var('dart_revision')),

  # WARNING: Unused Dart dependencies in the list below till "WARNING:"
  # marker are removed automatically - see create_updated_flutter_deps.py.

  'engine/src/flutter/third_party/dart/third_party/binaryen/src': (
      Var('chromium_git') +
      '/external/github.com/WebAssembly/binaryen.git@'
      '1d2e23d5e55788091a51420ba3a9889d4efe7509'),

  'engine/src/flutter/third_party/dart/third_party/devtools': {
      'dep_type': 'cipd',
      'packages': [{
          'package': 'dart/third_party/flutter/devtools',
          'version': 'git_revision:9360cc98ac03a6e50a9f56213fb7f45e62f55fcf'
      }]
  },
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/dart_style': (
      Var('dart_git') +
      '/dart_style.git@ca019b0498692ad78f5f0f0f6208a1258e17fc90'),

  'engine/src/flutter/third_party/dart/third_party/pkg/dartdoc': (
      Var('dart_git') +
      '/dartdoc.git@98d03ad2cc341d1fb053e0addfc96ba35301976b'),
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/native': (
      Var('dart_git') +
      '/native.git@3ec573500f743d4a1393f7802143aef50fec0a47'),
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/shelf': (
      Var('dart_git') +
      '/shelf.git@f30d65034a868530a9aa9ada7c3067d22fa01185'),
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/tar': (
      Var('dart_git') +
      '/external/github.com/simolus3/tar.git@'
      '13479f7c2a18f499e840ad470cfcca8c579f6909'),

  'engine/src/flutter/third_party/dart/third_party/pkg/test': (
      Var('dart_git') +
      '/test.git@8083c8f24ffbca58cc0385add03c296b70636e7a'),
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/vector_math': (
      ...
      Var('dart_vector_math_rev')),

  'engine/src/flutter/third_party/dart/third_party/pkg/web': (
      Var('dart_git') + '/external/github.com/dart-lang/web.git' + '@' +
      Var('dart_web_rev')),

  'engine/src/flutter/third_party/dart/third_party/pkg/webdev': (
      Var('dart_git') + '/external/github.com/dart-lang/webdev.git' + '@' +
      Var('dart_webdev_rev')),
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/webdriver': (
      Var('dart_git') +
      '/external/github.com/google/webdriver.dart.git' + '@' +
      Var('dart_webdriver_rev')),

  'engine/src/flutter/third_party/dart/third_party/pkg/'
  ...
  'engine/src/flutter/third_party/dart/tools/sdks/dart-sdk': {
      ...
      'packages': [{
          ...
          'version': 'git_revision:782552bdddc112c62db28ec7e9b2763f4457a3ea'
      }]
  },

  # WARNING: end of dart dependencies list that is cleaned up
  # automatically - see create_updated_flutter_deps.py.
  ...
  'engine/src/flutter/third_party/freetype2': (
      Var('flutter_git') + '/third_party/freetype2' + '@' +
  ...
  'engine/src/flutter/third_party/abseil-cpp': (
      Var('flutter_git') + '/third_party/abseil-cpp.git' + '@' +
      '3ff870f957d511627690f4d3601987ce40d0d97c'),
  ...
  'engine/src/flutter/third_party/android_tools/google-java-format': {
     ...
     # We want to be able to format these as part of CI, and the CI step
     # that checks formatting runs without downloading the rest of the Android
     # build tooling. Therefore unlike all the other Android-related tools,
     # we want to download this every time.
     'dep_type': 'cipd',
   },
     ...
     'packages': [
       {
        ...
        # 4. Review Android 16 release notes for lifecycle/foreground
        #    service changes
  ...
  'engine/src/flutter/third_party/java/openjdk': {
     ...
     # Always download the JDK since java is required for running the
     # formatter.
     'dep_type': 'cipd',
   },
  ...
  'engine/src/flutter/buildtools/mac-x64/clang': {
    ...
    # On ARM64 Macs too because Goma doesn't support the host-arm64
    # toolchain.
  ...
  # Get the SDK from
  # https://chrome-infra-packages.appspot.com/p/fuchsia/sdk/core at the
  # 'latest' tag
  # Get the toolchain from
  # https://chrome-infra-packages.appspot.com/p/fuchsia/clang at the 'goma'
  # tag
      ...
      'packages': [
          {
              ...
              'version': (
                  '44bd38be0bc8c189a397ca6dd6f737746a9e0c6117b96a8f84f1edf6'
                  'acd1206b')
          }
      ],
      'dep_type': 'cipd',
...
hooks = [
  {
    # Generate the Dart SDK's .dart_tool/package_config.json file.
    'name': 'Generate .dart_tool/package_config.json',
    'pattern': '.',
    'action': [
        'python3',
        'engine/src/flutter/third_party/dart/tools/generate_package_config.py'
    ],
  },
  {
    ...
    'action': [
        'python3',
        'engine/src/flutter/third_party/dart/tools/'
